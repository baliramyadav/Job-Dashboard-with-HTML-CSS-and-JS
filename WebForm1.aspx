<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="JobDashboard_HTML_CSS.WebForm1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Job Dashboard | By CoderBaba</title>
...
<body>
    ...
    <nav>
      <div class="navbar">
        <div class="logo">
          <img src="programmer.png" alt="logo"/>
          <h1>jobs</h1>
        </div>
        <ul>
          <li><a href="#">
